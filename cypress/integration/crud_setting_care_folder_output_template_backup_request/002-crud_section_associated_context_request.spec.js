...
describe('TEST HTTP REQUEST SECTION ASSOCIATED CONTEXT', () => {
    ...
    it("GET Associated Contexts", () => {
        cy.getRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasContext/GetConfigurationList?careFolderOutputTemplateBackupId=7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', headers, 1, 'cypress/fixtures/associatedContexts.json');
        cy.pause();
    });
    ...
    it("POST Associated Contexts", () => {
        ...
        cy.postRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasContext/Save', headers, body, '7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', 1);
        cy.pause();
    });
