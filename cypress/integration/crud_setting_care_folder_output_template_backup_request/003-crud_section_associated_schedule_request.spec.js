...
describe('TEST HTTP REQUEST SECTION ASSOCIATED SCHEDULE', () => {
    ...
    it("GET Associated Schedules", () => {
        cy.getRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasSchedule/GetConfigurationList?careFolderOutputTemplateBackupId=7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', headers, 3, 'cypress/fixtures/associatedSchedules.json');
        cy.pause();
    });
    ...
    it("POST Associated Schedules", () => {
        ...
        cy.postRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasSchedule/Save', headers, body, '7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', 1);
        cy.pause();
    });
