...
describe('TEST HTTP REQUEST SECTION ASSOCIATED SCHEDULE REPORT LAUNCHER', () => {
    ...
    it("GET Associated Report Launcher", () => {
        cy.getRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasReportLauncher/GetConfigurationList?careFolderOutputTemplateBackupId=7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', headers, 1, 'cypress/fixtures/associatedLauncher.json');
        cy.pause();
    });
    ...
    it("POST Associated Report Launcher", () => {
        ...
        cy.postRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupHasReportLauncher/Save', headers, body, '7ee1b53c-5714-31a1-3b5c-6d9e147f3d27', 1);
        cy.pause();
    });
