...
describe('TEST HTTP REQUEST CARE FOLDER OUTPUT TEMPLATE BACKUP', () => {
    ...
    let deleteValue = 'e52dc65f-e77d-8557-298c-ffe482046018';
    let start = "Bearer";
    let token;
    var headers;
    ...
    it("GET Care Folder Output Template Backup", () => {
        cy.getRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackup/GetConfigurationList', headers, 17, 'cypress/fixtures/careFolderOutputTemplateBackup.json');
        cy.pause();
    });
    ...
    it("POST Care Folder Output Template Backup", () => {
        ...
        cy.postRequest('https://debugsite.myequipe2/webapi/api/v1/CareFolderOutputTemplateBackupSettings/Save', headers, body, idGuid, 0);
        cy.pause();
    });
